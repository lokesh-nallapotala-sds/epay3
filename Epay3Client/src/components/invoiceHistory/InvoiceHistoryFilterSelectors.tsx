...
import { AccountResponse, InvoiceStatusType } from 'types';
...
interface Props {
  ...
  handleExportData: (option: string, data: Invoice[]) => void;
  dateFilterRef?: Ref<HTMLDivElement>;
  dateFilterActive?: boolean;
}

const InvoiceHistoryFilterSelectors = ({
  isCardFilter,
  isSoldTo,
  relatedAccounts,
  impersonatedUser,
...
const MemoizedInvoiceHistoryFilterSelectors = memo(
  InvoiceHistoryFilterSelectors,
);

export default MemoizedInvoiceHistoryFilterSelectors;
